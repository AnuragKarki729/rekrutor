  ...
  function CommonCard({title, icon, description, footerContent}){
    return(
        <Card className="flex bg-gray-100 flex-col gap-6 rounded-2xl p-8 transition duration-300
         hover:bg-white hover:shadow-2xl hover: shadow-gray-600/10 cursor-pointer w-50
         border-4 border-gray-600 sm:w-[300px] sm:mt-10 md:w-[300px] md:mt-10 lg:w-[300px] lg:mt-10 justify-evenly">
